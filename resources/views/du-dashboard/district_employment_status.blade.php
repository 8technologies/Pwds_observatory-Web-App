<div class="container card pt-5 mb-5" id="chart-description">
    <div class="row" id="chart-content">
        <div class="col-12" id="heading">
            <h5 class="text-center">Employment Status by Gender in {{ $districtName }}</h5>
        </div>
        <div class="col-12" id="item-select">
            <label for="EmploymentStatus">Employment Status:</label>
            <select id="district_employmentSelector">
    ...
    <div class="chart-container p-2 mb-2">
        <canvas id="districtEmploymentStatus"></canvas>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        updateChart(document.getElementById('district_employmentSelector').value);

        // Event listener for the selector
        document.getElementById('district_employmentSelector').addEventListener('change', function() {
